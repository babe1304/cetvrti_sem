...
module.exports = class Helper {
    ...
    deliveryDate() {
        // ZADATAK
        if (this.params["delivaryDate"] === undefined) return '';
        return this.params["delivaryDate"];
    }
    ...
    address() {
        // ZADATAK
        if (this.params["delivaryAdress"] === undefined) return '';
        return this.params["delivaryAdress"];
    }
    ...
    isDeliveryAlternativeSelected(val) {
        // ZADATAK
        if (stringToHTMLId(val) === this.params["deliveryAlternative"]) return 'selected';
        return undefined;
    }
